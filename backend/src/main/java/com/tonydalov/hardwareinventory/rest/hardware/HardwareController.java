...
public class HardwareController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id, @RequestBody HardwareDto hardware) {
        hardware.toEntity().setId(id);

        var updated = hardwareService.create(hardware);
